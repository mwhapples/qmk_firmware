 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |Grv/L2|  '"  |AltShf| Left | Right|                                       |  Up  | Down |   [  |   ]  | ~L2  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
...
[BASE] = LAYOUT_ergodox_pretty(
  ...
  KC_DEL,          KC_Q,        KC_W,          KC_F,    KC_P,    KC_G,    TG(QWERTY),           TG(SYMB),     KC_J,    KC_L,    KC_U,    KC_Y,              KC_SCLN,        KC_BSLS,
  KC_BSPC,         KC_A,        KC_R,          KC_S,    KC_T,    KC_D,                                        KC_H,    KC_N,    KC_E,    KC_I,    LT(MDIA, KC_O),           GUI_T(KC_QUOT),
  KC_LSPO,         CTL_T(KC_Z), KC_X,          KC_C,    KC_V,    KC_B,    KC_CLCK,                  KC_INS, KC_K,    KC_M,    KC_COMM, KC_DOT,           CTL_T(KC_SLSH), KC_RSPC,
...
[QWERTY] = LAYOUT_ergodox_pretty(
  ...
  KC_TRNS,         KC_A,        KC_S,          KC_D,    KC_F,    KC_G,                                        KC_H,    KC_J,    KC_K,    KC_L,    LT(MDIA, KC_SCLN), KC_TRNS,
  KC_TRNS,         CTL_T(KC_Z), KC_X,          KC_C,    KC_V,    KC_B,    KC_TRNS,              KC_TRNS,      KC_N,    KC_M,    KC_COMM, KC_DOT,           CTL_T(KC_SLSH), KC_TRNS,

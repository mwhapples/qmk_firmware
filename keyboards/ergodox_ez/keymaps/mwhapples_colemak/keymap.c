...
[QWERTY] = LAYOUT_ergodox_pretty(
  ...
  KC_TRNS,         KC_A,        KC_S,          KC_D,    LSFT_T(KC_F),    KC_G,                                        KC_H,    RSFT_T(KC_J),    KC_K,    KC_L,    LT(MDIA, KC_SCLN), KC_TRNS,
  KC_TRNS,         CTL_T(KC_Z), ALT_T(KC_X),          GUI_T(KC_C),    KC_V,    KC_B,    KC_TRNS,              KC_TRNS,      KC_N,    KC_M,    RGUI_T(KC_COMM), ALT_T(KC_DOT),           CTL_T(KC_SLSH), KC_TRNS,
